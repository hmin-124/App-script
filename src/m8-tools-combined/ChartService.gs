...
class ChartService {
  ...
  _getOrCreateChartDataSheet() {
    try {
      ...
      let sheet = spreadsheet.getSheetByName(DashboardConfig.SHEET_NAMES.CHART_DATA);
      if (!sheet) {
        sheet = spreadsheet.insertSheet(DashboardConfig.SHEET_NAMES.CHART_DATA);
      }
      sheet.hideSheet();
      sheet.clearContents();
      return sheet;
  ...
  createRevenueTrendChart(dailyReport, anchorRow, anchorCol) {
    try {
      ...
      const chart = this.dashboardSheet
        ...
        .setOption('width', DashboardConfig.LAYOUT.CHART_WIDTH_PX)
        .setOption('height', DashboardConfig.LAYOUT.CHART_HEIGHT_PX)
        .setOption('legend', { position: 'none' })
        .setOption('colors', [DashboardConfig.COLORS.TITLE_BG])
        .build();
  ...
  createCostRevenueChart(dailyReport, anchorRow, anchorCol) {
    try {
      ...
      const chart = this.dashboardSheet
        ...
        .setOption('colors', [DashboardConfig.COLORS.NEGATIVE, DashboardConfig.COLORS.POSITIVE])
        .build();
  ...
  createBrandChart(brandReport, anchorRow, anchorCol) {
    try {
      ...
      const chart = this.dashboardSheet
        ...
        .setOption('height', DashboardConfig.LAYOUT.CHART_HEIGHT_PX)
        .setOption('legend', { position: 'none' })
        .setOption('colors', [DashboardConfig.COLORS.CARD_LABEL_BG])
        .build();
  ...
  createMemberChart(memberReport, anchorRow, anchorCol) {
    try {
      ...
      const chart = this.dashboardSheet
        ...
        .setOption('height', DashboardConfig.LAYOUT.CHART_HEIGHT_PX)
        .setOption('legend', { position: 'none' })
        .setOption('colors', [DashboardConfig.COLORS.POSITIVE])
        .build();
